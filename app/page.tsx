    ...
    <main className="flex min-h-svh flex-col bg-background text-foreground selection:bg-primary/10">
      ...
      <section className="relative overflow-hidden pt-24 pb-32 md:pt-32 md:pb-40">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-6 text-center md:px-8">
          <h1 className="max-w-4xl font-heading text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            >
              <Link href="/vidshpjeguese.mp4" target="_blank">
                <Play className="mr-2 h-4 w-4 text-muted-foreground transition-colors group-hover:text-foreground" />
                Watch Demo
              </Link>
            </Button>
          </div>
            ...
            <Carousel opts={{ align: "start", loop: true }} className="w-full">
              <CarouselContent>
                {features.map((feature, index) => (
                  ...
                  >
                    <div className="group relative flex h-full flex-col gap-4 rounded-2xl border bg-background p-6 shadow-sm transition-all hover:shadow-md">
